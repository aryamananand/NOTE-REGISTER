...
def view_notes():
    ...
    screen11.geometry("800x300")

    all_files = os.listdir()

    Label(screen11, text = "Please use one of the filenames below:").pack()

    Label(screen11, text = "(Drag screen to the left if all filenames are not visible. Drag until all filenames are visible.)" ).pack() 
    ...
    Label(screen11, text = "Please enter filename (with extension) below:", fg = "blue").pack()

    Entry(screen11, textvariable = raw_filename1).pack()

    Button(screen11, command = view_notes1, text = "Select").pack()
...
def delete_note():
    ...
    screen14.title("Delete Note:")

    screen14.geometry("800x300")

    all_files = os.listdir()

    Label(screen14, text = "Please select one of the filenames below to delete:").pack()
    ...
    Label(screen14, text = "Please enter filename (with extension) below:").pack()

    Entry(screen14, textvariable = raw_filename2).pack()

    Button(screen14, command = delete_note1, text = "Select").pack()
...
def delete_note1():
    ...
    screen15.title("Deleted Note:")

    screen15.geometry("400x400")

    Label(screen15, text = filename3+ " removed").pack()
...
def user_not_found():
    ...
    screeen5.title("Success")

    screen5.geometry("150x100")

    Label(screen5, text = "User not founnd!").pack()
...
def login():
    ...
    Label(screen2, text = "Please enters details below to login:").pack()
